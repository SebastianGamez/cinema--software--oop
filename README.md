...
## Cinema Software OOP  is a software for buy and watch void seats for a film. This born as a university project, created with python and thought for be deployed in the server side of a web application.
